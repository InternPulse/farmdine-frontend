...
const eventData = [
  { id: 1, title: "World Farmer's Day", description: "World Farmers' Day, also known as National Farmers' Day, is celebrated on December 23rd every year. It is a day to recognize and appreciate the contributions of farmers to our society. Farmers play a vital role in feeding our communities, preserving natural resources, and supporting local economies." },
  ...
  return (
    <>
      <div>
        ...
        <div className="relative w-full max-w-lg mx-auto mt-8 overflow-hidden">
