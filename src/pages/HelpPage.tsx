		...
		<div className='bg-signup-form-background w-full h-full'>
			<div className='flex-col text-center max-w-3xl mx-auto justify-center items-center'>
				...
				<div className='font-openSans text-xl font-normal pb-6'>
					Explore our Farm<span className='text-green0'>dine</span> Help Center
					for answers to your questions and support with your experience.
				</div>
			...
			<div className='max-w-5xl mx-auto pb-20'>
				<div className='flex justify-between items-center gap-40'>
					<div className='flex-col max-w-lg font-sans'>
						...
						<button
							type='submit'
							className='bg-green0 px-5 py-4 text-lg font-semibold rounded-lg'
						>
							Submit a Ticket
						</button>
					</div>
			...
			<div className='max-w-4xl mt-40 flex justify-center flex-col items-center mx-auto pb-72'>
				<div className='bg-green0 rounded-2xl border flex mx-auto justify-between items-center px-16 py-5 w-full'>
					<h1 className='text-white font-semibold text-xl'>
						Can't find the answer you are looking for?
					</h1>
					<button className='bg-white text-green47 rounded-xl text-base font-medium px-12 py-5'>
						Get In Touch!
					</button>
				</div>
				...
				<button className='bg-green0 text-lg font-medium mt-10 px-12 py-5 rounded-xl'>
					Sign up
				</button>
			</div>
		</div>
