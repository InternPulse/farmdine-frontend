	...
	return (
		<div className='container mx-auto p-4'>
			<div className='flex justify-between mb-8 space-x-2'>
				<button
					className='bg-green-400 text-black font-bold uppercase py-3 px-8 rounded shadow'
					// style={{
			...
			<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4'>
				{products.map((product) => (
					<div
						key={product.id}
						className={`border p-4 rounded shadow-sm h-full bg-white min-h-[25rem] flex flex-col justify-between`} // Increased minimum height
					>
						<div className='relative flex justify-center items-center flex-1 mb-2'>
							...
							/>
							<span className='absolute top-2 right-2 bg-discount-bg text-black font-bold text-xs px-2 py-1 rounded'>
								{product.discount}
							</span>
						</div>
