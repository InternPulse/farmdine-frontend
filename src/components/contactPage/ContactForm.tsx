...
const ContactForm: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-contactForm">
      <div className="w-full max-w-2xl px-16 py-10 justify-center items-center inline-flex">
        <div className="self-stretch flex-col justify-start items-center gap-7 inline-flex">
          <div className="flex-col justify-start items-center gap-5 flex">
            ...
            <div className="text-zinc-600 text-xs font-normal font-['Roboto']">
          ...
          <form onSubmit={handleSubmit} className="flex-col justify-start items-center gap-11 flex w-full">
            <div className="flex-col justify-start items-start gap-11 flex w-full">
              <div className="flex justify-start items-start gap-8 w-full">
                <div className="flex-col justify-start items-start gap-2.5 flex w-1/2">
