    ...
    <div className="bg-gray-100 p-8">
      <div className="container mx-auto text-center">
        ...
        <div className="relative overflow-hidden">
          ...
          >
            <img src="src\assets\img1.png" alt="Logo 1" className="h-16" />
            <img src="src\assets\img2.png" alt="Logo 2" className="h-16" />
            <img src="src\assets\img3.png" alt="Logo 3" className="h-16" />
            <img src="src\assets\img4.png" alt="Logo 4" className="h-16" />
            <img src="src\assets\img5.png" alt="Logo 5" className="h-16" />
