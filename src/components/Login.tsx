	...
	return (
		<div className='flex justify-center items-center h-screen'>
			<div className='bg-white p-8 rounded-lg shadow-md w-96'>
				...
				<div className='mb-4'>
					<label htmlFor='emailOrPhone' className='block mb-1'>
				...
				<div className='flex items-center mb-4'>
					...
					<span className='ml-auto mr-4 cursor-pointer text-blue-500 underline'>
						Forgot your password?
					</span>
				</div>
				<button className='bg-lime-500 text-white px-3 py-2 rounded-lg w-full mb-4'>
					Sign in
				</button>
				...
				<div className='text-center'>
					<div>
						...
						<span className='text-lime-500 cursor-pointer underline'>
							Sign up now
						</span>
					</div>
				</div>
